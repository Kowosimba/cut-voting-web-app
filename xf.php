...
<body>
                                    ...
                                    echo('<div class="product__tile">
                                            <article class="product__card">
                                                ...
                                                <div class="product__dscrptx">
                                                    ...
                                                    <a   onclick="checker()" href="vt.php?id='.$uid.'&cid='.$row['cand_id'].'&pos='.$row['position'].'" class="purchbtn45">
                                                        VOTE
                                                    </a>
                                                </div>
                                            </article>
    ...
    <script> 
            function checker(){
                var result = confirm('Are you sure you want to vote for this candidate ?\n Press ok to confirm or cancel so that you can select another candidate\n\n NOTE: Once you vote for a candidate at each contesting position,\n All the candidates at that position will be removed on the page');
                if (result == false) {
