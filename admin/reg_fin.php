...
// if (isset($_POST['upload'])) {
    ...
    if (move_uploaded_file($tempname, $folder)) {
        ...
        echo ' <script> alert ("Error whilst uploading file")</script>';
    }
}
?>
<!DOCTYPE html>
            ...
            <div class="recent-orders">
                ...
                <section class="product section container" id="trending">
                    ...
                    <div id="contentsz" class="collection-card card">
                        <form method="POST" action="<?php echo $_SERVER['PHP_SELF'];?>" enctype="multipart/form-data" class="formsz contact__form">
                            <div class="contact__inputs">
                                <div class="contact__content">
                                    <input type="text" name = "part" placeholder=" " class="contact__input">
                                    <label for="" class="contact__label">Party</label>
                                </div>
                                <div class="contact__content">
